...
var lawn_key_list = []
var current_seed = 0
var seed_list = [null, preload("res://scenes/gorilla.tscn"), preload("res://scenes/bee_hive.tscn"), preload("res://scenes/hog.tscn"), preload("res://scenes/hedgehog_bomb.tscn"), preload("res://scenes/elephant.tscn"), preload("res://scenes/pangolin.tscn")]
var shove = false
var shovel_pos = Vector2(410, 25)
var pos
var endangered1_pos = Vector2(208, 107)
var endangered2_pos = Vector2(208, 171)
	...
	if event is InputEventMouseButton:
		...
		if pos.x > 32 and pos.x < 448 and pos.y > 56 and pos.y < 216:
			if pos.x > 196 and pos.x < 224 and pos.y > 88 and pos.y < 120 and !event.pressed and current_seed != 0:
				...
				allbutone_slot_reset(0)
				return
			if pos.x > 196 and pos.x < 224 and pos.y > 152 and pos.y < 184 and !event.pressed and current_seed != 0:
				current_seed = 0
				allbutone_slot_reset(0)
				return
			match current_seed:
...
func _physics_process(delta):
	...
	if endangered1.dead == true or endangered2.dead == true:
		trigger_game_loss()
