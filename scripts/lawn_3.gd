...
var lawn_key_list = []
var current_seed = 0
var seed_list = [null, preload("res://scenes/gorilla.tscn"), preload("res://scenes/bee_hive.tscn"), preload("res://scenes/hog.tscn"), preload("res://scenes/hedgehog_bomb.tscn")]
var shove = false
...
func _physics_process(delta):
	...
	cooldown_seed1.value += 30 * global.speed
